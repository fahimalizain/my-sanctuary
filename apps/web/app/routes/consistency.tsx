    ...
    <div className="bg-white rounded-xl p-6 shadow-sm">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-sanctuary-green/10 rounded-lg text-sanctuary-green">
            {rule.icon}
          </div>
          <div>
        ...
        <span className="text-xs px-2 py-1 bg-gray-100 rounded-full text-muted-foreground">
          {rule.schedule}
        </span>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center gap-1 text-sanctuary-green mb-1">
      ...
      <div className="flex items-center gap-1">
        ...
        {rule.history.map((met, i) => (
          <div
            ...
            className={cn(
              'h-6 w-6 rounded',
              met ? 'bg-sanctuary-green' : 'bg-red-200'
            )}
          />
        ))}
      </div>
...
export function ConsistencyComponent() {
  return (
    <div className="min-h-screen bg-cream">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <p className="text-3xl font-bold text-sanctuary-green">72%</p>
